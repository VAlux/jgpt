...
class AutoGradTest {
   ...
   */
  private static AutoGradNode node(double value, float[] childGrads, List<AutoGradNode> children) {
  ...
  class Root {
    ...
    void rootGradIsOverwrittenWithOne() {
      ...
      AutoGradNode root = new AutoGradNode(5d, 0.7d, new float[0], List.of());
  ...
  class SingleOperation {
    ...
    void addPropagatesGradToBothOperands() {
      ...
      AutoGradNode sum = node(5d, new float[]{1f, 1f}, List.of(a, b));
    ...
    void mulPropagatesUsingChainRule() {
      ...
      AutoGradNode a = leaf(2d);
      AutoGradNode b = leaf(3d);
      AutoGradNode product = node(6d, new float[]{(float) b.value(), (float) a.value()}, List.of(a, b));
  ...
  class CompositeGraph {
    ...
    void nestedExpressionAppliesChainRule() {
      ...
      AutoGradNode sum = node(5d, new float[]{1f, 1f}, List.of(a, b));        // a + b
      AutoGradNode product = node(20d, new float[]{(float) c.value(), (float) sum.value()}, List.of(sum, c)); // sum * c
    ...
    void deepChainMultipliesLocalDerivatives() {
      ...
      AutoGradNode a = leaf(2d);
      AutoGradNode x1 = node(6d, new float[]{3f}, List.of(a));
      AutoGradNode x2 = node(30d, new float[]{5f}, List.of(x1));
  ...
  class SharedNodes {
    ...
    void diamondAccumulatesGradientsFromAllPaths() {
      ...
      AutoGradNode a = leaf(2d);
      AutoGradNode b = node(4d, new float[]{2f}, List.of(a));
      AutoGradNode c = node(6d, new float[]{3f}, List.of(a));
      AutoGradNode d = node(10d, new float[]{1f, 1f}, List.of(b, c));
    ...
    void sameChildListedTwiceAccumulates() {
      ...
      AutoGradNode square = node(9d, new float[]{(float) a.value(), (float) a.value()}, List.of(a, a));
  ...
  class CycleDetection {
    ...
    void cycleThrowsIllegalStateException() {
      ...
      AutoGradNode a = new AutoGradNode(1d, new float[]{1f}, List.of());
      AutoGradNode b = new AutoGradNode(1d, new float[]{1f}, List.of());
